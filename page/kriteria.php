...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if ($update) {
		$sql = "UPDATE kriteria SET kd_beasiswa=$_POST[kd_beasiswa], nama_ktra='$_POST[nama]', sifat='$_POST[sifat]' WHERE kd_kriteria='$_GET[key]'";
	} else {
	...
	if ($validasi) {
		$q = $connection->query("SELECT kd_kriteria FROM kriteria WHERE kd_beasiswa=$_POST[kd_beasiswa] AND nama_ktra LIKE '%$_POST[nama]%'");
		if ($q->num_rows) {
	        ...
	        <div class="panel-body">
	            <form action="<?=$_SERVER['REQUEST_URI']?>" method="POST">
	                ...
	                <div class="form-group">
	                    ...
	                    <input type="text" name="nama" class="form-control" <?= (!$update) ?: 'value="'.$row["nama_ktra"].'"' ?>>
	                </div>
									<div class="form-group">
	    ...
	    <div class="panel panel-info">
	        ...
	        <div class="panel-body">
	            <table class="table table-condensed">
	                ...
	                <tbody>
	                    <?php $no = 1; ?>
	                    <?php if ($query = $connection->query("SELECT a.nama_ktra AS kriteria, b.nama_bsw AS beasiswa, a.kd_kriteria, a.sifat FROM kriteria a JOIN beasiswa b USING(kd_beasiswa)")): ?>
